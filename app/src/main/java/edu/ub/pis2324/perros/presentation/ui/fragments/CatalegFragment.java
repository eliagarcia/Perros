...
public class CatalegFragment extends Fragment {
  ...
  private void initObservers() {
    ...
    catalegViewModel.getProductsState().observe(getViewLifecycleOwner(), state -> {
    ...
    catalegViewModel.getHiddenProductState().observe(getViewLifecycleOwner(), position -> {
